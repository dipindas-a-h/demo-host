...
const createBookingPdfTheme3 = async (activity) => {
    let combinedHtmlDoc = "";
    let options = {
        format: "A4",
        type: "buffer",
...
>
    ...
    >
        ...
        <div>
            <div style="font-size: large; font-weight: bold">Travel Date</div>
        ...
        <div>
            <div style="font-size: large; font-weight: bold">Adult count</div>
            <div style="font-size: large">${activity.adultsCount}</</div>
            <div style="font-size: large; font-weight: bold">
                --------------
            </div>
        </div>
        <div>
            <div style="font-size: large; font-weight: bold">Child Count</div>
            <div style="font-size: large">${activity.childrenCount}</</div>
            <div style="font-size: large; font-weight: bold">
                --------------
            </div>
        </div>
        <div>
            <div style="font-size: large; font-weight: bold">Booking Number</div>
            <div style="font-size: large"> ${
                activity.attraction._id === "63ff12f5d7333637a938cad4"
                    ? activity.voucherNumber
                    : activity.bookingConfirmationNumber
