const { dubaiParkAuhthentication } = require("../../admin/helpers/dubaiParkAuth");
const axios = require("axios");

module.exports = {
    createDubaiParkOrder: async (apiId, attractionOrder, activity, act) => {
        try {
                ...
                productList: [
                    {
                        ...
                        quantity: Number(activity.adultsCount) + Number(activity.childrenCount),
                    },
                ],
            ...
            throw new Error("Dubai park tickets not available now");
        }
    },
};
