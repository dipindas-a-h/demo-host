...
const sendAttractionOrderAdminEmail = async (attractionOrder) => {
    try {
        sendAdminEmail(
            `New Order Placed -${attractionOrder.referenceNumber}`,
            ...
            <div style="background-color: #f7f7f7; padding: 20px;">
              <p style="font-size: 18px; font-weight: bold;">Dear Admin,</p>
              <p style="margin-top: 20px;">New order details are as follows:</p>
              <table style="width: 100%; margin-top: 20px; border-collapse: collapse;">
              <tr style="background-color: #eee;">
              <td style="padding: 10px; border: 1px solid #ddd;">Name:</td>
              <td style="padding: 10px; border: 1px solid #ddd;">${attractionOrder.name}</td>
            </tr>
                <tr style="background-color: #eee;">
