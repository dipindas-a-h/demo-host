    ...
    try {
        ...
        sendEmail(
            ...
            <div style="margin:50px auto;width:70%;padding:20px 0">
              ...
              <p>Thank you for choosing ${data?.COMPANY_NAME}. Use the otp code  and  complete your change password procedures</p>
              ...
              <p style="margin: 20px 0;">Thank you for choosing ${data?.COMPANY_NAME}</p>
