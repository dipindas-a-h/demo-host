...
const { getSingleVisa,listAll, applyVisa ,visaApplicationInvoice, completeVisaReapplyDocumentOrder ,completeVisaPaymentOrder , completeVisaDocumentOrder} = require("../../controllers/visa/b2bVisaController");
