...
} = require("../../b2b/validations/hotel/hotelAvailability.schema");
...
const { createHotelLog } = require("../../b2b/helpers/hotel/hotelLogsHelpers");
...
module.exports = {
    ...
    getSingleHotelAvailability: async (req, res) => {
        try {
            ...
            // console.log(availableHotels?.length);
