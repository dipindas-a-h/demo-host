...
const b2bAccountCancellationEmail = async ({ name, email }) => {
    try {
        sendEmail(
            email,
            ...
            <br />
            <span>Your account hase been cancelled by the admin.</span><br />
            <br />
            <br />
...
module.exports = b2bAccountCancellationEmail;
