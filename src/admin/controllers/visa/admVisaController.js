...
const { visaSchema, visaTypeSchema, visaUpdateSchema } = require("../../validations/visa.schema");

module.exports = {
    createNewVisa: async (req, res) => {
        try {
            const { country, name, termsAndConditions, inclusions, description, faqs, details } =
                req.body;
